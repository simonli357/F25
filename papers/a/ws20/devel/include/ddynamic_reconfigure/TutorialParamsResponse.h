...
struct TutorialParamsResponse_
{
  ...
  _double_param_type double_param;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _str_param_type;
...
struct Printer< ::ddynamic_reconfigure::TutorialParamsResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ddynamic_reconfigure::TutorialParamsResponse_<ContainerAllocator>& v)
  {
    ...
    s << indent << "str_param: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.str_param);
    s << indent << "bool_param: ";
